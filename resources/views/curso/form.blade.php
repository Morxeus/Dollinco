<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="nombre_curso" class="form-label">{{ __('Nombre curso *') }}</label>
            <input type="text" name="NombreCurso" class="form-control @error('NombreCurso') is-invalid @enderror" value="{{ old('NombreCurso', $curso?->NombreCurso) }}" id="nombre_curso" placeholder="Nombre curso">
